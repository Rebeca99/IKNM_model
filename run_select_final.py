...
# simulation with division and INM (no differentiation rate domain) # baseline for Rebeca's models -> simulation type 100
...
# simulation with division and INM (no differentiation rate domain) # Rebeca model 1 -> simulation type 4: delayed drift + noise
...
# simulation with division and INM (no differentiation rate domain) # Rebeca model 2 -> simulation type 5: drift = v0 & noise
...
# simulation with division and INM (no differentiation rate domain) # Rebeca model 3 -> simulation type 6: delayed drift + noise + force
...
# simulation with division and INM (no differentiation rate domain) # Rebeca model 4 -> type 7: drift = v0 & noise & force
...
# These following simulation types were NOT used by Rebeca

# simulation with division, INM and no differentiation rate - with both pD and pMN
...
# simulation with division and all the cells are differentated as pNM diff_rate_hours (1/h)
...
# simulation with division with INM and 2 diferent populations (with and without differentiation rate)
...
# simulation with division with INM and all the cells high without differentiation rate
